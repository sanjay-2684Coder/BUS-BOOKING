  ...
  return (
    <nav className={`w-full h-[8ch] fixed top=0 left-0 lg:px-24 md:px-16 sm:px-7 px-4 backdrop-blur-lg transition-transform duration-300 z-50 
      ...
      <div className="w-full h-full flex items-center justify-between">
        ...
        {/*Hamburger menu */}
        <div className="w-fit md:hidden flex items-center justify-center cursur-pointer flex-col gap-1 text-neutral-700" onClick={handleOpen}>
          {
            open
            ?
