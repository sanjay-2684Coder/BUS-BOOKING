        ...
        <div className="w-full rounded-xl p-5 border-2 border-neutral-300 space-y-5">
            <div className="space-y-5 w-full border-b border-neutral-300/60 pb-4">
                ...
                <div className="space-y-5 ">
                    ...
                    <div className="space-y-0.5">
                        <div className="w-full flex items-center justify-between gap-x-2.5">
                            ...
                            <div className="flex-1 border-dashed border border-neutral-300 relative">
                                <p className="absolute w-14 h-14 p-0.5 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-neutral-50 border border-dashed border-neutral-400 rounded-full flex items-center justify-center">
                    ...
                    <div className="w-full flex items-center justify-between gap-x-5">
                        <p className="text-base text-neutral-500 font-normal">{routeFrom} ➝ {routeTo}</p>
                    </div>
                </div>
            </div>
            ...
            <div className="w-full flex items-center justify-between">
                ...
                <Link 
                    ...
                    className="w-fit px-5 py-1.5 h-full bg-primary hover:bg-transparent border-2 border-primary hover:border-primary rounded-xl text-sm font-normal text-neutral-50 flex items-center justify-center gap-x-2 hover:text-primary ease-in-out duration-300"
                    aria-label={`Reserve a seat on ${busName}`}
                >
                    Reserve Seat
                </Link>
            </div>
